...
**NO UNVERIFIABLE CITATIONS**: Do not create citations for information that cannot be specifically referenced or verified. Avoid citations like "no relevant publications/records found" or similar placeholder citations.
...
**ARABIC NUMERALS REQUIREMENT**: Always use Arabic numerals (1, 2, 3, 17,439, 30%, etc.) for all numbers, data, statistics, and measurements. Do NOT use written-out numbers.
...
- **No Placeholder Citations**: Never create citations for missing information or use generic statements like "no relevant records found"
